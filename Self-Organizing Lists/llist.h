...
public:
  ...
  void append(const E& it) { // Append "it" to list
	...
	tail->setAccessed(0);		//Set the tail accesses at zero
	head->setAccessed(0);		//Set the head accesses at zero
    cnt++;
  }
  ...
  void setTimesAccessed(int n) {
	  curr->setAccessed(n);		//Set the number of accesses for the current link
  }
